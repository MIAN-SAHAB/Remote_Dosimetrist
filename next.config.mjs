...
const nextConfig = {
  ...
  async headers() {
    ...
    //  - WordPress media/API on api-rd.demo-link.tech
    ...
    const csp = [
      ...
      "img-src 'self' data: blob: https://api-rd.demo-link.tech https://www.googletagmanager.com https://www.google-analytics.com https://*.google-analytics.com https://www.gstatic.com https://www.google.com https://*.doubleclick.net",
      "font-src 'self' data:",
      "connect-src 'self' https://api-rd.demo-link.tech https://www.googletagmanager.com https://www.google-analytics.com https://*.google-analytics.com https://*.analytics.google.com https://www.google.com https://*.doubleclick.net",
